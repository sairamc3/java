...
class Client {
    public static void main(String[] args) {
        System.out.println("A demo with Single Responsibility Principle");
        System.out.println("----------------------------------------------");
    ...
    private static void showEmpDetail(Employee emp) {
        ...
        System.out.println("The emp Id: " + new EmployeeIdGenerator().generateEmpId(emp.firstName));
        System.out.println("The employee is a " + new SeniorityChecker().checkSeniority(emp.experienceInYears));
    }
}
