package org.paumard.scopedvalues.B_travelandforecast.model.weather;

import org.paumard.scopedvalues.B_travelandforecast.B_BookTravel;
...
public record Weather(String weather, String server) {
    ...
    public Weather {
        if (!B_BookTravel.licenceKey.isBound() ||
            ...
            throw new IllegalStateException("Incorrect licence");
        }
    }
